...
public class StudentSearch {
    ...
    // Define the searchStudent method that takes an array of Student objects (students)
    // and an integer rollNumber as parameters
    public static Student searchStudent(Student[] students, int rollNumber) {
        ...
        // If no student is found with the target roll number, return null
        return null;
    }
    ...
    public static void main(String[] args) {
        ...
        // Check if student is found or not
